                    ...
                    <jsp:include page="header.jsp"></jsp:include>
                        ...
                        <div class="container-fluid">
                            ...
                            <div>
                                ...
                                <a href="${root}/admin/manager_admin.jsp">Quay về danh sách quản trị</a>
                        </div>
                        <br/>
                                ...
                                <form action="${root}/AdminServlet" method="post">
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="name" id="name" placeholder="Nhập họ tên..." required="yes" >
                                            <%=error%>
                                        </div>
                                        <div class="form-group col-md-6">
