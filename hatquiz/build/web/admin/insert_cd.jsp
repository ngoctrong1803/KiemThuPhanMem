                    ...
                    <jsp:include page="header.jsp"></jsp:include>
                        ...
                        <div class="container-fluid">
                            ...
                            <div>
                                ...
                                <a href="${root}/admin/manager_cd.jsp">Quay về danh sách countdown</a>
                        </div>
                        <br/>
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">THÊM MỚI COUNTDOWN</h6>
                            </div>
                            <div class="card-body">
                                <form action="${root}/ManagerCountDownServlet" method="post">
                                    <div class="row">
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control" name="year" id="year" placeholder="Nhập năm thi..." required="yes" >
                                            <%=error%>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="startday">Ngày bắt đầu</label>
                                            <input type="text" class="form-control" name="startday" id="startday" placeholder="Nhập ngày bắt đầu..." required="yes" >
                                            <%=error%>
                                        </div>
                                        <div class="form-group col-md-5">
                                            <label for="note">Ghi chú</label>
                                            <textarea type="text" class="form-control" name="note" id="note" placeholder="Ghi chú..." required="yes" rows="5"></textarea>
                                            <%=error%>
                                        </div>
                                    </div>
