                    ...
                    <jsp:include page="header.jsp"></jsp:include>
                        ...
                        <div class="container-fluid">
                            ...
                            <div>
                                ...
                                <a href="${root}/admin/manager_quiz.jsp?pages=1">Quay về danh sách đề thi</a>
                        </div>
                        <br/>
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">THÊM MỚI ĐỀ THI</h6>
                            </div>
                            <div class="card-body">
                                <form action="${root}/ManagerQuizServlet" method="post">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-5">
                                            ...
                                            <input type="text" class="form-control" name="name" id="name" placeholder="Nhập tên đề thi..." required="yes" >
                                            <%=error%>
                                        </div>
                                        <div class="form-group col-md-2">
                                            <label for="time">Thời gian</label>
                                            <input type="text" class="form-control" name="time" id="time" placeholder="Nhập thời gian..." required="yes">
                                            <%=error%>
                                        </div>
                                        <div class="form-group col-md-2">
                                            <label for="totalquestion">Tổng số câu</label>
                                            <input type="text" class="form-control" name="totalquestion" id="totalquestion" placeholder="Nhập tổng số câu..." required="yes">
                                            <%=error%>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-8">
                                            ...
                                            <input type="text" class="form-control" name="image" id="image" placeholder="Nhập link ảnh..." required="yes">
                                            <%=error%>
                                        </div>
                                    </div>
