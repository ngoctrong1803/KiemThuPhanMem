                    ...
                    <jsp:include page="header.jsp"></jsp:include>
                        ...
                        <div class="container-fluid">
                            ...
                            <div>
                                ...
                                <a href="${root}/admin/manager_banner.jsp">Quay về danh sách banner</a>
                        </div>
                        <br/>
                                ...
                                <form action="${root}/ManagerBannerServlet" method="post">
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <textarea type="text" class="form-control" name="content" id="content" rows="5" placeholder="Nhập nội dung..." required="yes" ></textarea>
                                            <%=error%>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="image">Ảnh</label>
                                            <textarea type="text" class="form-control" name="image" id="image" rows="5" placeholder="Nhập ảnh..." required="yes"></textarea>
                                            <%=error%>
                                        </div>
                                    </div>
